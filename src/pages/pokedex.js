...
import { CAUGHT_KEY } from '../lib/constants.js';
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Also listen for custom events when Pokemon are caught on the same page
...
/**
 * View Pokemon details (placeholder for future enhancement)
 */
